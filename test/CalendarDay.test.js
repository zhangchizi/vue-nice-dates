...
describe('CalendarDay.vue', () => {
  it('should display day', () => {
    ...
    expect(wrapper.get('.nice-dates-day_date').text()).toBe(date.getDate().toString())
  })
  ...
  it('should add class names and styles to <span>', () => {
    const date = new Date()
    const modifiers = {
      disabled: false,
      selected: true
    ...
    expect(wrapper.element.style.height).toMatch('20px')
  })
})
